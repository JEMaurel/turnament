                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <div className="flex justify-between items-center">
                            ...
                            <button 
                                onClick={() => setInsuranceIdIsPriority(prev => !prev)}
                                title={insuranceIdIsPriority ? "quitar prioridad de n° afiliado" : "dar prioridad a n° afiliado"}
  ...
  const appointmentsForSelectedDay = useMemo((): AppointmentWithDetails[] => {
    ...
    for (const app of filteredApps) {
      ...
      result.push({
        ...
        insuranceIdIsPriority: patient?.insuranceIdIsPriority,
      });
    }
    ...
    <div className="h-screen bg-slate-900 text-white p-4 sm:p-6 lg:p-8 flex flex-col overflow-hidden">
      <header className="flex flex-wrap justify-between items-center mb-6 gap-4 flex-shrink-0">
        ...
        <div className="flex items-center flex-wrap gap-3">
            ...
            <button onClick={() => setGlobalLinksModalOpen(true)} title="ver enlaces rápidos" className="flex items-center gap-2 bg-purple-600 hover:bg-purple-500 text-white font-bold py-2 px-4 rounded-lg transition-colors">
